...
import PortfolioNavbar from "../../Components/LandingPage-Components/LandingPageNavbar";
import PortfolioFooter from "../../Components/LandingPage-Components/LandingPageFooter";
        ...
        <div className="flex-1 h-full flex flex-col  bg-gradient-to-br from-green-50 via-green-100 to-purple-100 justify-center items-center">
          <div className="w-1/2 flex flex-col items-center justify-center gap-3">
            ...
            <p className="text-center text-sm">
              ...
              exercitationem saepe quod, ut error cum dolorum beatae ex animi
              expedita.
            </p>
        ...
        <div className=" flex-1 h-full flex justify-center items-center">
          <div className="w-1/2 flex flex-col items-center justify-center gap-3">
            ...
            <p className="text-center text-sm">
              ...
              Obcaecati, placeat sed consectetur saepe quibusdam officiis
              laborum eaque ex quod sunt.
            </p>
            <button className="btn btn-outline btn-success">
